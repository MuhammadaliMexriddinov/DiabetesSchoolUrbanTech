...
public final class ScreenMainBinding implements ViewBinding {
  ...
  private ScreenMainBinding(@NonNull ConstraintLayout rootView, @NonNull SmoothBottomBar bottomBar,
  ...
  public static ScreenMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ScreenMainBinding((ConstraintLayout) rootView, bottomBar, fragmentContainer);
    }
