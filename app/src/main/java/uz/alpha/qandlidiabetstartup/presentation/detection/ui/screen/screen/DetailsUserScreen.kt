...
import uz.alpha.qandlidiabetstartup.databinding.ScreenChatUserBinding
...
class DetailsUserScreen : Fragment(R.layout.screen_chat_user) {

    private val binding by viewBinding(ScreenChatUserBinding::bind)
