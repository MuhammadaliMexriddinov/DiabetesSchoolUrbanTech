...
class InformationAdapter(private var mList: List<InfoData>) :
    RecyclerView.Adapter<InformationAdapter.LanguageViewHolder>() {
    ...
    fun setFilteredList(mList: List<InfoData>) {
        this.mList = mList
